      ...
      /* Login/Registration form open/close script */
      ...
      /* Music player open/close script */

      document.getElementById("player_button").addEventListener("click", function(){
        document.querySelector(".player").style.display = "flex";
      })

      document.querySelector("#player_close").addEventListener("click", function(){
      ...
      let track_list = [
        {
          name: "???",
          artist: "???",
          image: "https://w0.peakpx.com/wallpaper/973/584/HD-wallpaper-girl-headphones-phone-candy-pink-anime.jpg",
          path: ""
        },
        {
          name: "",
